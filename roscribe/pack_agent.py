...
from roscribe.tools import get_rag_tools, get_launch_tool, get_package_tool, get_cmake_tool, get_readme_tool
...
class PackAgent:
    def __init__(self, ros_distro, ros_graph_dict, ros_node_desc, ros_nodes, project_name, ws_name,
                 model_name="gpt-4o-mini", max_interaction_limit=6, verbose=False):
