...
from roscribe.tools import get_rag_tools, get_gen_graph_tool 
from roscribe.prompts import get_spec_agent_prompt, get_node_desc_prompt, get_graph_gen_prompt
import roscribe.ui as ui

class SpecAgent:
    def __init__(self, ros_distro, model_name="gpt-4o-mini", max_interaction_limit=6, verbose=False):
        ...
        agent_memory = ConversationBufferWindowMemory(memory_key="chat_history", k=max_interaction_limit, return_messages=True)
